<template>
  <div class="demo">
    <h2>基础用法</h2>
    <miner-picker mode="selector" :list-data="listData1" @confirm="confirm">
      <miner-cell title="请选择城市" :desc="desc"></miner-cell>
    </miner-picker>
    <h2>多列样式</h2>
    <miner-picker mode="multiSelector" :list-data="listData2" @confirm="confirm2">
      <miner-cell title="请选择时间" :desc="desc2"></miner-cell>
    </miner-picker>
  </div>
</template>
<script lang="ts">

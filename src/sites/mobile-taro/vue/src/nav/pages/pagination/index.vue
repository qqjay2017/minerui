<template>
  <div class="demo">
    ...
    <h2>显示省略号</h2>
    <miner-pagination v-model="currentPage2" :total-items="125" :show-page-size="3" force-ellipses @change="pageChange" />
    <h2>自定义按钮</h2>
    <miner-pagination v-model="currentPage3" :total-items="500" :show-page-size="5" @change="pageChange">
      <template #prev-text>

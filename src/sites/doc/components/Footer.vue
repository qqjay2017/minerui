  ...
  <div class="doc-footer" :class="`doc-footer-${themeColor}`">
    <div class="doc-footer-content">
      ...
      <div class="doc-footer-list">
        ...
        <div class="doc-footer-item"
          ><a class="sub-link" target="_blank" href="https://github.com/qqjay2017/minerui" v-hover>GitHub</a></div
        >
        <div class="doc-footer-item"
        ...
        <div class="doc-footer-item vx-item">
          ...
          <div class="vx-box">
            ...
            <p class="vx-desc">回复<span class="vx-red">MinerUI</span>即刻进群</p>
          </div>
        </div>
      </div>
      <div class="doc-footer-list">
        ...
        <div class="doc-footer-item"><a class="sub-link" href="mailto:minerui@jd.com" v-hover>联系我们</a></div>
        <div class="doc-footer-item"
          ><a class="sub-link" target="_blank" href="https://github.com/qqjay2017/minerui/issues" v-hover
            >意见反馈</a
          ></div
        >
        <div class="doc-footer-item"
...
export default defineComponent({
  ...
  setup() {
    ...
    const checkTheme = (color: string, index: number) => {
      ...
      localStorage.setItem('minerui-theme-color', color);
    };
    return {

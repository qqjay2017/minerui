    ...
    <miner-cell-group title="checkboxGroup使用">
      <miner-cell>
        <miner-checkboxgroup v-model="checkboxgroup1">
          <miner-checkbox label="1" style="margin: 2px 20px 0 0"
            >组合复选框</miner-checkbox
          >
          <miner-checkbox label="2">组合复选框</miner-checkbox>
          <miner-checkbox label="3" style="margin: 2px 20px 0 0"
            >组合复选框</miner-checkbox
          >
    ...
    <miner-cell-group title="checkboxGroup 全选/取消">
      <miner-cell>
        <miner-checkboxgroup
          ...
          @change="changeBox4"
        >
          <miner-checkbox label="1" style="margin: 0 20px 0 0"
            >组合复选框</miner-checkbox
          >
          <miner-checkbox label="2">组合复选框</miner-checkbox>
        </miner-checkboxgroup>

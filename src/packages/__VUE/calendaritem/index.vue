<template>
  <view
    class="miner-calendar miner-calendar-taro"
    :class="{
      'miner-calendar-tile': !poppable,
      'miner-calendar-nofooter': isAutoBackFill
    }"
  >
    <!-- header -->
    <view
      class="miner-calendar-header"
      :class="{ 'miner-calendar-header-tile': !poppable }"
    >
    ...
    <!-- footer-->
    <view class="miner-calendar-footer" v-if="poppable && !isAutoBackFill">

<template>
  <view :class="classes">
    <view
      class="miner-elevator__list"
      ref="listview"
      :style="{ height: isNaN(+height) ? height : `${height}px` }"
    >
      <view
        class="miner-elevator__list__item"
        v-for="item in indexList"
        :key="item[acceptKey]"
        :ref="setListGroup"
      >
        <view class="miner-elevator__list__item__code">{{
          item[acceptKey]
        }}</view>
        <view
          class="miner-elevator__list__item__name"
    ...
    <view
      class="miner-elevator__code--current"
      v-show="scrollStart"
      v-if="indexList.length"
      >{{ indexList[currentIndex][acceptKey] }}</view
    >
    <view
      class="miner-elevator__bars"
      @touchstart="touchStart"
      @touchmove.stop.prevent="touchMove"
      @touchend="touchEnd"
    >
      <view class="miner-elevator__bars__inner">
        <view
          class="miner-elevator__bars__inner__item"
          :data-index="index"

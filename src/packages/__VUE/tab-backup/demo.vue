  ...
  <div class="demo full">
    ...
    <miner-tab>
      <miner-tab-panel tab-title="全部"
        ><p class="content">这里是页签全部内容</p></miner-tab-panel
      >
      <miner-tab-panel tab-title="待付款"
        ><p class="content">这里是页签待付款内容</p></miner-tab-panel
      >
      <miner-tab-panel tab-title="待收获"
        ><p class="content">这里是页签待收获内容</p></miner-tab-panel
      >
      <miner-tab-panel tab-title="已完成"
        ><p class="content">这里是页签已完成内容</p></miner-tab-panel
      >
    </miner-tab>

    <h2>defaultIndex设置默认显示tab,iconType为half时切换选中icon样式</h2>
    <h2>switchTab监听切换tab返回事件</h2>
    <miner-tab :default-index="1" @switch-tab="switchTab" icon-type="half">
      <miner-tab-panel tab-title="全部"
        ><p class="content">这里是页签全部内容</p></miner-tab-panel
      >
      <miner-tab-panel tab-title="待付款"
    ...
    >
    <miner-tab :animated-time="500" scrollType="scroll">
      <miner-tab-panel tab-title="全部"
        ><p class="content">这里是页签全部内容</p></miner-tab-panel
      >
      <miner-tab-panel tab-title="待付款"
      ...
      <miner-tab-panel tab-title="已取消"
        ><p class="content">这里是页签已取消内容</p></miner-tab-panel
      >
      <miner-tab-panel tab-title="待评价"
        ><p class="content">这里是页签待评价内容</p></miner-tab-panel
      >
    </miner-tab>

    <h2>设置slot:header可以自定义标签</h2>
    <miner-tab scrollType="scroll">
      <miner-tab-panel tab-title="全部">
    ...
    >
      <miner-tab-panel tab-title="页签一"
        ><p class="content">这里是页签一内容</p></miner-tab-panel
      >
      <miner-tab-panel tab-title="页签二"
        ><p class="content">这里是页签二内容</p></miner-tab-panel
      >
      <miner-tab-panel tab-title="页签三"
        ><p class="content">这里是页签三内容</p></miner-tab-panel
      >
      <miner-tab-panel tab-title="页签四"
        ><p class="content">这里是页签四内容</p></miner-tab-panel
      >
      <miner-tab-panel tab-title="页签五"
        ><p class="content">这里是页签五内容</p></miner-tab-panel
      >
      <miner-tab-panel tab-title="页签六"
        ><p class="content">这里是页签六内容</p></miner-tab-panel
      >
      <miner-tab-panel tab-title="页签七"
        ><p class="content">这里是页签七内容</p></miner-tab-panel
      >
    </miner-tab>

    <h2>异步操作</h2>
    <miner-tab :animated-time="500" v-if="editList.length > 0">
      <miner-tab-panel

<template>
  <div class="demo">
    <h2>每列不显示中文</h2>
    <miner-cell title="日期选择" :desc="desc1" @click="open(0)"></miner-cell>
    <h2>限制开始结束时间</h2>
    <miner-cell title="日期选择" :desc="desc2" @click="open(1)"></miner-cell>
    <h2>限制开始结束时间（有默认值）</h2>
    <miner-cell title="日期时间选择" :desc="desc3" @click="open(2)"></miner-cell>
    <h2>限制开始结束小时</h2>
    <miner-cell title="时间选择" :desc="desc4" @click="open(3)"></miner-cell>
    <h2>分钟数递增步长设置</h2>
    <miner-cell title="时间选择" :desc="desc5" @click="open(4)"></miner-cell>

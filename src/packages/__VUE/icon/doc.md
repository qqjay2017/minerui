...
// vue
import { Icon } from '@minerui/minerui';
// taro
import { Icon } from '@minerui/minerui-taro';
...
-->
<miner-icon font-class-name="iconfont" class-prefix="icon" name="close" />
```
...
-->
<miner-icon font-class-name="my-icon" class-prefix="my-icon" name="extra" />
...
| font-class-name | 字体基础类名     | String           | `minerui-iconfont` |
| class-prefix | 类名前缀，用于使用自定义图标     | String           | `miner-icon` |

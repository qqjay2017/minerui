<template>
  <view :class="classes" @click="handleClick">
    ...
    <template v-else-if="showPlainText">
      <view class="miner-cd-block">{{ plainText }}</view>
    </template>
    <template v-else>
      <template v-if="resttime.d >= 0 && showDays">
        <view class="miner-cd-block">{{ resttime.d }}</view>
        <view class="miner-cd-dot">天</view>
      </template>
      <view class="miner-cd-block">{{ resttime.h }}</view
      ><view class="miner-cd-dot">:</view
      ><view class="miner-cd-block">{{ resttime.m }}</view
      ><view class="miner-cd-dot">:</view
      ><view class="miner-cd-block">{{ resttime.s }}</view>
    </template>
  </view>
</template>
<script lang="ts">

<template>
  <div class="demo full">
    ...
    <miner-swipe>
      ...
      <template #right>
        <miner-button shape="square" style="height: 100%" type="danger"
          >删除</miner-button
        >
      </template>
    </miner-swipe>
    ...
    <miner-swipe>
      <template #left>
        <miner-button shape="square" style="height: 100%" type="success"
          >选择</miner-button
        >
      </template>
      ...
      <template #right>
        <miner-button shape="square" style="height: 100%" type="danger"
          >删除</miner-button
        >
        <miner-button shape="square" style="height: 100%" type="info"
          >收藏</miner-button
        >
      </template>
    </miner-swipe>

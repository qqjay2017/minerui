<template>
  <view :class="classes">
    ...
    >
      <miner-icon
        :size="iconSize"
        class="miner-rate-item__icon"
        :class="{ 'miner-rate-item__icon--disabled': disabled || n > modelValue }"
        :color="n <= modelValue ? activeColor : voidColor"
        :name="n <= modelValue ? checkedIcon : uncheckedIcon"
      />
      <miner-icon
        v-if="allowHalf && modelValue + 1 > n"
        class="miner-rate-item__icon miner-rate-item__icon--half"
        :color="n <= modelValue ? activeColor : voidColor"
        :size="iconSize"
        :name="checkedIcon"
      />
      <miner-icon
        ...
        class="
          miner-rate-item__icon
          miner-rate-item__icon--disabled
          miner-rate-item__icon--half
        "
        :color="voidColor"
        :size="iconSize"
        :name="uncheckedIcon"

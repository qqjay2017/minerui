<template>
  <view :class="classes">
    ...
    >
      ...
      <view class="tab-title">
        <view
          :class="[
            'tab-title-box',
            { 'miner-tab-active': activeIndex == item.id || activeIndex == index }
          ]"
    ...
    <view class="miner-navbar__right" :class="{ icon }" v-if="desc || icon">
      <view
        v-if="desc"

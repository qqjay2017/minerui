    ...
    >
      ...
      <view ref="wrap" class="wrap">
        <view
          ...
          :class="[
            animationClass,
            { 'miner-ellipsis': !scrollable && !wrapable }
          ]"
          :style="contentStyle"
      ...
      <view v-if="closeMode" class="right-icon" @click.stop="onClickIcon">
        <miner-icon name="close" :color="color"></miner-icon>
      </view>
    </view>

    <view
      class="miner-noticebar-vertical"
    ...
    >
      ...
      <view class="go" @click="!slots.rightIcon && handleClickIcon()">
        ...
        <template v-else-if="closeMode">
          <miner-icon type="cross" :color="color" size="11px"></miner-icon>
        </template>
      </view>
    </view>
  </view>

<template>
  <div :class="classes">
    <div class="miner-signature-inner" ref="wrap">
      <canvas
        ref="canvas"
        :height="canvasHeight"
        :width="canvasWidth"
      ...
      ></canvas>
      <p class="miner-signature-unsopport" v-else>{{ unSupportTpl }}</p>
    </div>

    <miner-button class="miner-signature-btn" type="default" @click="clear()"
      >重签</miner-button
    >
    <miner-button class="miner-signature-btn" type="primary" @click="confirm()"
      >确认</miner-button
    >
  </div>
</template>

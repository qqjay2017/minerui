<template>
  <view :class="classes">
    <view class="miner-uploader__slot" v-if="$slots.default">
      <slot></slot>
      <template v-if="maximum - fileList.length">
        <input
          class="miner-uploader__input"
          v-if="capture"
          type="file"
          capture="camera"
          :accept="accept"
    ...
    <template v-else>
      <view
        class="miner-uploader__preview"
        v-for="(item, index) in fileList"
        :key="item.uid"
      >
        <view class="miner-uploader__preview-img">
          <miner-icon
            v-if="isDeletable"
          ...
          ></miner-icon>
          <img
            class="miner-uploader__preview-img__c"
      ...
      <view class="miner-uploader__upload" v-if="maximum - fileList.length">
        <miner-icon
          :size="uploadIconSize"
          color="#808080"
          :name="uploadIcon"

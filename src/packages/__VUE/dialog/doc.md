...
import { Dialog } from '@minerui/minerui';
...
```html
<miner-dialog :title="title" :close-on-click-overlay="false" :content="content" v-model:visible="visible"></miner-dialog>
```

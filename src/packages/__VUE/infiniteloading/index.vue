<template>
  <view
    ...
    @touchend="touchEnd"
  >
    <view class="miner-infinite-top" ref="refreshTop" :style="getStyle">
      <view class="top-box">
        <miner-icon class="top-img" :name="pullIcon"></miner-icon>
        <view class="top-text">{{ pullTxt }}</view>
      </view>
    </view>

    <view class="miner-infinite-container">
      <slot></slot>
    </view>

    <view class="miner-infinite-bottom">
      <template v-if="isInfiniting">
        <view class="bottom-box">
          <miner-icon class="bottom-img" :name="loadIcon"></miner-icon>

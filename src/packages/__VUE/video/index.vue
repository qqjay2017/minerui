<template>
  <div class="miner-video" ref="videocon">
    <video
      ref="root"
      class="miner-video-player"
      :muted="options.muted"
    ...
    <!-- 错误弹窗 -->
    <div class="miner-video-error" v-show="state.isError">

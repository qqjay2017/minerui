      ...
      <view class="miner-range-bar" :style="barStyle">
        <template v-if="range">
          <view
            ...
            role="slider"
            :class="{
              'miner-range-button-wrapper-left': index == 0,
              'miner-range-button-wrapper-right': index == 1
            }"
          ...
          >
            ...
            <view class="miner-range-button" v-else :style="buttonStyle">
        ...
        <template v-else>
          <view
            role="slider"
            class="miner-range-button-wrapper"
            :tabindex="disabled ? -1 : 0"
            :aria-valuemin="+min"

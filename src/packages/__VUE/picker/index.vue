<template>
  <view :class="classes">
    <miner-popup
      ...
      @close="close"
    >
      <view class="miner-picker__bar">
        <view class="miner-picker__left miner-picker__button" @click="close">{{
          cancelText
        }}</view>
        <view> {{ title }}</view>
        <view class="miner-picker__button" @click="confirm()">{{ okText }}</view>
      </view>

      <view class="miner-picker__column">
        <view
          class="miner-picker__mask"
          :style="{ backgroundSize: `100% ${top}px` }"
        ></view>
        <view class="miner-picker__hairline" :style="{ top: ` ${top}px` }"></view>
        <view
          class="miner-picker__columnitem"
